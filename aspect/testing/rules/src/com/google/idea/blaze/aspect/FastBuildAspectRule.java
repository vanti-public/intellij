...
public final class FastBuildAspectRule implements TestRule {
  ...
  public FastBuildAspectTestFixture loadTestFixture(String testRelativeLabel) throws IOException {
    String label = testRelativeLabel(testRelativeLabel);
  ...
  public String testRelativeLabel(String path) {
    checkArgument(path.contains(":"));
    String relativePath = path.startsWith(":") ? packagePath + path : packagePath + "/" + path;
    return "//" + relativePath;
  }
}
